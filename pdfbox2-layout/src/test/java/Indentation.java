...
public class Indentation {
	...
	paragraph.add(new Indent(new ArabicEnumerator().next() + " ", 4,
		SpaceUnit.em, 11, PDType1Font.TIMES_BOLD, EAlignment.Right));
	...
	paragraph.add(new Indent(new LowerCaseRomanEnumerator().next() + " ",
		4, SpaceUnit.em, 11, PDType1Font.TIMES_BOLD, EAlignment.Right));
