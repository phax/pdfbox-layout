...
public class ExampleTest
{
  ...
  protected static void comparePdfs (final File newPdf, final InputStream toCompareTo) throws IOException,
                                                                                       AssertionError
  {
    try (PDDocument currentDoc = PDDocument.load (newPdf); PDDocument oldDoc = PDDocument.load (toCompareTo))
    {
