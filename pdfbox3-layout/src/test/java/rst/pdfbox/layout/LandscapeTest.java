...
public class LandscapeTest extends AbstractExampleTest
{
  ...
  public void test () throws Exception
  {
    ...
    final Paragraph titleA4 = new Paragraph ();
    titleA4.addMarkup ("*Format A4 in Portrait*", 20, EBaseFont.Times);
    final Paragraph titleA5 = new Paragraph ();
    titleA5.addMarkup ("*Format A5 in Landscape*", 20, EBaseFont.Times);

    final PageFormat a5_landscape = PageFormat.with ().A5 ().landscape ().margins (10, 50, 0, 30).build ();
    final PageFormat a4_portrait = PageFormat.with ().margins (40, 50, 40, 60).build ();
    final Document document = new Document (a4_portrait);
    ...
    final OutputStream outputStream = new FileOutputStream ("landscape.pdf");
