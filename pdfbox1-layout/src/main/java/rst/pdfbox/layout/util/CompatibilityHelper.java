...
public class CompatibilityHelper {
	...
	// Fresh instance per call: a shared PDBorderStyleDictionary wraps a
	// COSDictionary that gets tied to the first PDDocument it is attached
	// to, leaking state across documents in long-running JVMs.
